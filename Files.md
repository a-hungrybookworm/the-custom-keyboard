# files
1. README.md — a writeup of your project: what you built, why, and what you learned
1. PCB files — your KiCad project (schematics, layout, Gerbers). To export from KiCad:
...
3. Case files — your Onshape exports for the case and plate. To export from Onshape:
...
5. Photos — progress shots and your finished build
